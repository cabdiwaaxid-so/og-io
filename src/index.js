...
const DEFAULT_BASE_URL = 'https://og-io.vercel.app';
...
/**
 * Resets the base URL to the default public API
 * @example
 * resetBaseUrl();
 */
 ...
 * 
 * @example
 * // Basic usage with default public API
...
// ES Module exports
export { og, setBaseUrl, resetBaseUrl, getBaseUrl, setFetch, DEFAULT_BASE_URL };
export default api;